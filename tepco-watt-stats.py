...
# -*- coding: utf-8 -*-
"""
Source: https://github.com/sh-kawakami/tepco-watt-stats
"""

__author__ = "KAWAKAMI Shinnosuke"
__credits__ = ["KAWAKAMI Shinnosuke", "Su Wei"]
__license__ = "Apache-2.0 License"
__version__ = "0.1.0"
__maintainer__ = "Su Wei"
...
parser.add_argument('date',
                    help="使用量を取得したい日付(YYYY-MM-DD もしくは YYYY-MM もしくは YYYY)")
parser.add_argument('-j', '--json', help="JSON 形式で出力", action="store_true")
parser.add_argument('-u', '--user', help="ログインユーザーID")
parser.add_argument('-p', '--password', help="ログインパスワード")
